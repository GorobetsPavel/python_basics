...
class Cell:
    ...
    def __sub__(self, other):
        if self.num_cells > other.num_cells:
            ...
            print('Вычитать возможно только, если разность количества ячеек двух клеток больше нуля')
            return Cell(0)
    ...
    def make_order(self, cells_in_row, ex=None):
        if ex is None:
            num_cells = self.num_cells
        else:
            num_cells = ex.num_cells
        return '\n'.join((num_cells * '*')[i:i + cells_in_row] for i in range(0, num_cells, cells_in_row)) + '\n'


cell_1 = Cell(20)
cell_2 = Cell(7)

print((cell_1 + cell_2).num_cells)
print((cell_1 - cell_2).num_cells)
print((cell_2 - cell_1).num_cells)
print((cell_1 * cell_2).num_cells)
print((cell_1 / cell_2).num_cells)

print(cell_1.make_order(6, (cell_1 + cell_2)))
